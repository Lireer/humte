...
/// For this the formular from [here](https://carnotcycle.wordpress.com/2012/08/04/how-to-convert-relative-humidity-to-absolute-humidity/) is used and is supposedly accurate to within 0.1% over the temperature range -30°C to +35°C.
